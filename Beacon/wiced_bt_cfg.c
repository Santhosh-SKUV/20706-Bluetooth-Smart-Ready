...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_advert_cfg =                                                                                // BLE advertisement settings
    {
        ...
        .low_duty_min_interval           = 800,                                                     // Low duty undirected connectable minimum advertising interval. 800 *0.625 = 500ms
        .low_duty_max_interval           = 800,                                                     // Low duty undirected connectable maximum advertising interval
